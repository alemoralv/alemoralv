...
source = build_dir / "originals" / "atelier-kie.png"
output_dir = project_dir / "assets" / "daylight"
...
desktop_path = output_dir / "atelier-desktop.webp"
desktop.save(desktop_path, "WEBP", quality=85, method=6)

# Art-directed phone plate uses the rightmost portrait crop: the glass remains
# visible and the expansive pale upper field stays behind the compact headline.
...
mobile_path = output_dir / "atelier-mobile.webp"
